...
class GrupoModel extends Model {
	...
	protected $table = 'cad_grupo';
	protected $primaryKey = 'id';
	protected $returnType = \App\Entities\Financeiro\Grupo::class;
	protected $useSoftDeletes = false;
	protected $allowedFields = ['gru_descricao', 'gru_tipo', 'gru_classificacao', 'status', 'created_user_id', 'updated_user_id', 'deleted_user_id'];
	...
	{
		return $this->select('id, gru_descricao')->find($codigo);
	}
