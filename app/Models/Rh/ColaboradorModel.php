...
class ColaboradorModel extends Model
{
	...
	protected $allowedFields = ['pessoa_id', 'usuario_id', 'dt_admissao', 'dt_desligamento', 'salario', 'status', 'created_user_id', 'updated_user_id', 'deleted_user_id'];
	...
	{
		return $this->select('id, pessoa_id')->find($codigo);
	}
