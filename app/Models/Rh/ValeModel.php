...
class ColaboradorModel extends Model
{
	...
	protected $table = 'fin_vale';
	protected $primaryKey = 'id';
	protected $returnType = \App\Entities\Rh\Colaborador::class;
	protected $useSoftDeletes = true;
	protected $allowedFields = ['colaborador_id', 'dt_solicitacao', 'valor', 'motivo_solicitacao', 'status', 'created_user_id', 'updated_user_id', 'deleted_user_id', 'can_user_id', 'can_motivo'];
	...
	{
		return $this->select('id,colaborador_id')->find($codigo);
	}
