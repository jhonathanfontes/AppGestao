            ...
            <div class="card-body">
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col no-print">
                            ...
                            <div class="form-group row" style="font-size: 13px;">
                                <div class="hidden">
                                    <input type="text" name="cod_orcamento" id="conf_codOrcamento" value=""
                                        hidden="hidden">
                                    <input type="text" name="serial" id="conf_Serial" value="" hidden="hidden">
                                    <input type="text" id="tipo_atual" value="" hidden="hidden">
                                </div>
                                <div class="col-sm-3">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" name="cod_tipo" id="vendaAVista" value="1">
                                        <label for="vendaAVista"> A VISTA </label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" name="cod_tipo" id="vendaAPrazo" value="2">
                    ...
                    <div class="col-sm-12 invoice-info no-print">
                        ...
                        <div class="row">
                            <div class="hidden">
                                <input type="text" name="cod_obra" value="<?php echo $orcamento->cod_orcamento ?>"
                                    hidden="hidden">
                                <input type="text" name="cod_local" value="<?php echo $orcamento->serial ?>"
                                    hidden="hidden">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="cat_grade" id="cat_grade" class="form-control select2bs4"
                            ...
                            <div class="col-sm-1" style="text-align: center;">
                                ...
                                <button type="submit" id="submitAdicionar" class="form-control btn btn-success" disabled
                                    onclick="AddProdutoOrcamento()"><i class="fas fa-cart-plus"> </i></button>
                            </div>
                        </div>
                        <?= form_close(); ?>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: center;"><button
                                                    ...
                                                    id="DeletarDetalheSelect" hidden> <samp
                                                        class="fas fa-trash-alt fa-sm"></samp> EXCLUIR SELECIONADOS</button>
                                            </td>
                                        </tr>
                                    </tfoot>
                                <?php endif; ?>
