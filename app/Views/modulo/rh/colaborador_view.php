                ...
                <div class="col-2">
                    ...
                    if (isset($pessoa->status)) {
                        if ($pessoa->status == 1 or $pessoa->status == 2) { ?>
                            <button type="button" class="btn btn-xs btn-dark ml-2" onclick="getArquivar( 'pessoa' , <?= isset($pessoa->cod_pessoa) ? $pessoa->cod_pessoa : null;  ?>)"><samp class="fa fa-archive"></samp> ARQUIVAR</button>
                    <?php
                        }
                    }
                    ?>
                ...
                <div class="col-sm-4 invoice-col">
                    <address>
                        <table>
                            <tr style="width: 40px;">
                                <th>Nome</th>
                                <td><?= isset($pessoa->cad_nome) ? $pessoa->cad_nome : 'CADASTRO NÃO LOCALIZADO!';  ?></td>
                            </tr>
                            <tr>
                                <th>Apelido</th>
                ...
                <div class="col-sm-4 invoice-col">
                    <address>
                        <table>
                            <tr>
                                <th>E-mail</th>
                                <td><?= isset($pessoa->cad_email) ? $pessoa->cad_email : '';  ?></td>
                            </tr>
                            <tr>
                                <th>Telefone</th>
                                <td><?= isset($pessoa->cad_telefone) ? $pessoa->cad_telefone : '';  ?></td>
                            </tr>
                            <tr>
                                <th>Celular</th>
                                <td><?= isset($pessoa->cad_celular) ? $pessoa->cad_celular : '';  ?></td>
                            </tr>
                        </table>
                    </address>
                </div>
                                        ...
                                        <td class="text-right no-print">
                                            <a href="<?php // echo base_url(); 
                                                        ?>report/consultarvenda/<?php // echo $row->serial 
                                                                                ?>" class="btn btn-xs btn-primary"><span class="far fa-eye"></span> VISUALIZAR</a>
                                        </td>
                                    </tr>
                                    <?php $sequencia++; ?>
                                <?php endforeach; ?>
