<div class="modal fade" id="modalSubgrupo" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <<?= form_open(base_url('/api/financeiro/salvar/subgrupo'), ['method' => 'post', 'id' => 'formSubgrupo']) ?>
                <div class="card-body">
                    <div class="row">
                        <div class="hidden">
                        ...
                        <div class="form-group col-5">
                            ...
                            <select name="cod_grupo" id="cod_grupo" class="form-control select2bs4"
                                style="width: 100%;">
                        ...
                        <div class="form-group col-7">
                            ...
                            <input name="cad_subgrupo" id="cad_subgrupo" type="text" class="form-control"
                                placeholder="">
                        </div>
                    </div>
                    <div class="col-md-10">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary" id="SalvarSubGrupo" onclick="SalvaSubGrupos()"><i
